...
namespace HexEngine
{
	...
	void Texture2D::BlendTo_Additive(ITexture2D* other, IShader* optionalShader)
	{
		g_pGraphics->Lock();
	...
	void Texture2D::BlendTo_Additive_Double(ITexture2D* other, IShader* optionalShader)
	{
		g_pGraphics->Lock();
	...
	void Texture2D::BlendTo_Alpha(ITexture2D* other, IShader* optionalShader)
	{
		g_pGraphics->Lock();
	...
	void Texture2D::BlendTo_NonPremultiplied(ITexture2D* other, IShader* optionalShader)
	{
		g_pGraphics->Lock();
