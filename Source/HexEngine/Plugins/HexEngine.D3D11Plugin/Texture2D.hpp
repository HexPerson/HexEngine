...
class Texture2D : public HexEngine::ITexture2D
{
...
public:
	...
	virtual void BlendTo_Additive(ITexture2D* other, HexEngine::IShader* optionalShader) override;

	virtual void BlendTo_Additive_Double(ITexture2D* other, HexEngine::IShader* optionalShader) override;

	virtual void BlendTo_Alpha(ITexture2D* other, HexEngine::IShader* optionalShader) override;

	virtual void BlendTo_NonPremultiplied(ITexture2D* other, HexEngine::IShader* optionalShader) override;
