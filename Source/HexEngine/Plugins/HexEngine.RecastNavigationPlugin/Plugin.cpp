...
HexEngine::IPluginInterface* RecastPlugin::CreateInterface(const std::string& interfaceName)
{
	...
	//
	if (interfaceName == HexEngine::INavMeshProvider::InterfaceName)
		return _interface;
