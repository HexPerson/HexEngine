...
HexEngine::IRigidBody* PhysicsSystemPhysX::CreateController(const HexEngine::ControllerParameters& params, HexEngine::Transform* transform)
{
	_scene->lockWrite();
	...
	character->SetBodyType(HexEngine::IRigidBody::BodyType::Dynamic);
...
HexEngine::IRigidBody* PhysicsSystemPhysX::CreateRigidBody(HexEngine::Transform* transform, HexEngine::RigidBody* bodyComponent, HexEngine::IRigidBody::BodyType type, const math::Vector3& offset)
{
	_scene->lockWrite();
	//_scene->lockRead();
	...
	else
	{
		...
		if (type == HexEngine::IRigidBody::BodyType::Kinematic)
...
HexEngine::IRigidBody* PhysicsSystemPhysX::CloneRigidBody(HexEngine::IRigidBody* physicsBody, HexEngine::Transform* transform, HexEngine::RigidBody* bodyComponent, HexEngine::IRigidBody::BodyType type)
{
	_scene->lockWrite();
	//_scene->lockRead();
...
void PhysicsSystemPhysX::DestroyRigidBody(HexEngine::IRigidBody* body)
{
...
void PhysicsSystemPhysX::DebugRender()
{
	...
	{
		HexEngine::g_pEnv->_debugRenderer->DrawLine(
...
void PhysicsSystemPhysX::onTrigger(physx::PxTriggerPair* pairs, physx::PxU32 count)
{
	for (physx::PxU32 i = 0; i < count; i++)
	{
...

		{
			...
			HexEngine::Entity* triggerEnt = (HexEngine::Entity*)triggerBody->GetEntity();
			HexEngine::Entity* actorEnt = (HexEngine::Entity*)actorBody->GetEntity();
...
uint32_t PhysicsSystemPhysX::RayCast(const math::Vector3& from, const math::Vector3& unitDir, float maxDist, HexEngine::IRigidBody* body, HexEngine::RayHit* hitInfo)
{
	...
	HexEngine::Entity* entity = bodyComp->GetEntity();
...
void PhysicsSystemPhysX::CreateHingeJoint(HexEngine::IRigidBody* bodies[2], const math::Vector3 axes[2], const math::Vector3 offsets[2])
{
